...
languages = sorted(['ell', 'ell2', 'eng', 'rus', 'deu', 'cat', 'spa', 'hin', 'isl', 'hye', 'fra', 'ita', 'hbs', 'gle', 'bul', 'ady', 'ang', 'swe', 'sqi', 'ast', 'bel', 'est', 'osx', 'fas', 'ukr', 'urd', 'kat', 'nld', 'eus', 'lav', 'zul', 'que', 'dan', 'bak', 'pol', 'ara', 'heb', 'fao', 'gal', 'grc', 'ces', 'lit','nav', 'vec', 'dsb', 'por', 'ron', 'tur', 'hun', 'nob', 'san', 'cym', 'mkd', 'swc', 'slv', 'ben'])
supported_tagset = {}
